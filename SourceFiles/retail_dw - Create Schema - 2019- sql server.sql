...
CREATE TABLE Dim_Reject_Codes(
    DI_Reject_ID                int              IDENTITY(1,1) NOT NULL,
...
CREATE TABLE DimProduct(
    ...
    Product_ID                       nvarchar(24)     NULL,  -- 20190417
    Brand_ID                         nvarchar(24)     NULL,  -- 20190417
    ProductLabel                     nvarchar(24)     NOT NULL,
    ProductName                      nvarchar(500)    NULL,
    ProductDescription               nvarchar(400)    NULL,
    ProductSubcategoryKey            int              NULL,
    ProductSubcategoryLabel          nvarchar(100)    NULL,
    ProductSubcategoryName           nvarchar(50)     NULL,  -- 20190417
...
CREATE TABLE DimProductCost(
    SCD_ProductCostSK      int               IDENTITY(1,1),
...
CREATE TABLE DimProductPrice(
    SCD_ProductPriceSK     int               IDENTITY(1,1),
    ProductSK              int               NOT NULL,
    CurrencyKey            int               NOT NULL,
...
CREATE TABLE DimSalesTerritory(
    SalesTerritorySK         int              IDENTITY(1,1),
...
CREATE TABLE FactExchangeRate(
    ExchangeRateSK      int               IDENTITY(1,1),
...
CREATE TABLE FactStrategyPlan(
    StrategyPlanSK        int               IDENTITY(1,1),
